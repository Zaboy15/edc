...
if(!isset($_GET['modal']) && !isset($_GET['qa'])) {
    ...
    elseif($route == "pdf" || $route == "system/import/assetsSample" || $route == "system/import/merchantSample" || $route == "system/import/licensesSample"|| $route == "system/import/sampledataSPK") {
        // do nothing if pdf
    }
