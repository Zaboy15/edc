...
if(!isset($_GET['modal']) && !isset($_GET['qa'])) {
    ...
    elseif($route == "pdf" || $route == "system/import/assetsSample" || $route == "system/import/customerSample" || $route == "system/import/merchantSample" || $route == "export/exportDataSPK" || $route == "export/exportAddedWithdraw" || $route == "export/exportDataTicket" || $route == "system/import/licensesSample"|| $route == "system/import/sampledataSPK"|| $route == "system/import/samplestaff"|| $route == "system/import/sampleUpdateSPK") {
        // do nothing if pdf
    }
